...
public class Car02Activty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Get Car name
        carName = findViewById(R.id.carNameTwo);
        ...
        select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Car02Activty.this, BookingActivity.class);
