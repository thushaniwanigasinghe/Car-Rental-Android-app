...
public class Car05Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_car05);
        ...
        //Get Car name
        carName = findViewById(R.id.carNameFive);
        ...
        select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Car05Activity.this, BookingActivity.class);
